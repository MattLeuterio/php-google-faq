...
?>
    ...
    <header class="main-header">
        <div class="main-header__logo u_flex">
            <img src="assets/img/logo-google.png" alt="logo google">
            <h1>Privacy e termini</h1>
        </div>
        <nav class="main-header__nav u_flex">
            <ul class="main-header__nav__list u_flex">
                <li class="intro"><a href="#">Introduzione</a></li>
                <li><a href="#">Norme sulla privacy</a></li>
                <li><a href="#">Termini di servizio</a></li>
                <li><a href="#">Tecnologie</a></li>
                <li class="active-link"><a href="#">Domande Frequenti</a></li>
            </ul>
    ...
    <main class="main-ctn">
        <?php // print Question and Answers
